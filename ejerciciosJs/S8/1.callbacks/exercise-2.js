...
// La función confirmExample recibirá una variable de tipo string (description) que mostrará como titulo de la ventana y 
// retornará el valor del confirm. La función promptExample hará lo mismo pero con un prompt. 
